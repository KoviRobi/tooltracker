    ...
    flake-utils.lib.eachDefaultSystem
      (system:
        ...
        in
        {
          ...
          nixosModules.tooltracker = { config, ... }:
            let
              inherit (pkgs.lib) mkOption mkEnableOption mkPackageOption mkIf types;
          ...
          nixpkgs.lib.nixosSystem {
            modules = [
              ...
              ({ config, lib, pkgs, modulesPath, ... }: {
                ...
                boot.initrd.availableKernelModules = [ "nvme" "ata_piix" "xen_blkfront" ];
                ...
                # TODO: Customize to your own config
                nix.settings.trusted-public-keys = [ "promethium-nix1:GfINhsNRWatD91mYMa9VTTywjNctN6l2T2FUlNP7DLc=" ];
                ...
                security.sudo.defaultOptions = [ "SETENV" "NOPASSWD" ];
